...
public class SelectPizzaCat {
     ...
     */
    public SelectPizzaCat(Activity activity) {
     ...
     */
    public void fetchingSelectedCat(final PizzaListAdapter adapter, final List<Album> albumList) {
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for(int i = 0 ; i<getResult.length; i++){
                            Album a = new Album(getResult[i].getId(), getResult[i].getName(),
                        ...
                        // a = new Album("Fresh Veg", "Oniun Crisp Capsicum", covers[1]);
                        Log.e("Pizza Cat Response:", "Result Length" + getResult.length
                        + " demo array size: " +  albumList.size());
